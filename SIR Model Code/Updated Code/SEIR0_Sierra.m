...
infected = [infectedData' 4678        4862        5368  ]';
day2 = day1(idxI);
%day2 = [day2' 194 199 204 206 211 213 218]';
dayI = [day2' 194 199 204]';

death = [death(idxD(1:41))' 1070 1130 1169 1187]';
dayD = [day1(idxD(1:41))' 194 196 201 203]';
...
if (isCalculateCI)
    ...
    disp('bootstrap CI: ');
    disp([betaHat' bootCI']);
    save resultCI_Sierra betaHat bootCI
